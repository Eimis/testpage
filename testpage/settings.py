...
SECRET_KEY = 'z0=wyi^l8#lz8mv2+$8ry#w*w)2tq=@#pc2$1-jwj2rx^-1l!l'
...
#  !!
DATABASES['default'] =  dj_database_url.config(default='postgres://eimantas:maxmaxkit@localhost/testdb')
